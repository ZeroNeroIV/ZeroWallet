  ...
  // ── Transactions ──────────────────────────────────────────
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        vaultType: { type: 'string', description: 'Wallet id or name, e.g. main, savings, salary (defaults to main)' },
      },
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        vaultType: { type: 'string', description: 'New wallet id or name' },
      },
  ...
  // ── Subscriptions ─────────────────────────────────────────
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        vaultType: { type: 'string', description: 'Wallet id or name to deduct from (defaults to main)' },
      },
  ...
  // ── Recurring Expenses ────────────────────────────────────
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        vaultType: { type: 'string', description: 'Wallet id or name to deduct from' },
